const cases = {
  "mot-platzer": {
    ...
    details: [
      ...
      ["Min roll", "Idé, copy, tonalitet, struktur och visuellt upplägg."],
  ...
  vbk: {
    ...
    images: [
      ...
      ["vbk-3.jpg", "Citatbild från VBK:s vd"],
      ["vbk-4.jpg", "Karusellbild om läget vid Lilla Bommen"],
      ["vbk-5.jpg", "Karusellbild om utsikten över älven"],
      ["vbk-6.jpg", "Karusellbild om hållbarhet i vardagen"],
      ["vbk-7.jpg", "Citatbild om vardagen i lokalerna"],
      ["vbk-8.jpg", "Avslutande CTA till kundcaset"]
    ]
  },
  film: {
    ...
    details: [
      ...
      ["Min roll", "Copy, intervjufrågor, innehållsupplägg, videoredigering, textning, grafik, musikläggning och formatanpassning."],
      ["Format", "Från presentationsfilm i bredbild till korta, textade sociala format för mobil visning."]
    ],
    links: [
      ["Se klippet från årsstämman", "https://youtu.be/qauttk0vXfw?t=120"],
      ["Se varumärkesfilmen", "https://www.instagram.com/reels/DTfxEM3CDwQ/"],
